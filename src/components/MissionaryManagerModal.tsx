...
import { X, Users, Plus, Trash2, Edit2, Check, ShieldCheck, Clock, Building2, RotateCcw, UserCheck, Lock } from 'lucide-react';
        ...
        <div className="p-6 space-y-5 overflow-y-auto flex-1">
          ...
          {isAdmin ? (
            ...
            <div className="bg-blue-50/50 dark:bg-blue-950/20 border border-blue-200/60 dark:border-blue-900/50 rounded-2xl p-3.5 flex items-center gap-3 text-xs text-blue-800 dark:text-blue-300">
              ...
              <span>Modo de Visualização: Apenas o administrador (estoquecristolandia@gmail.com) pode cadastrar ou alterar missionários.</span>
            </div>
          )}
