...
const variantStyles: Record<string, string> = {
  ...
  success: 'bg-emerald-50 text-emerald-800 border-emerald-200/80 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-800/80',
  ...
  warning: 'bg-amber-50 text-amber-800 border-amber-200/80 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-800/80',
  ...
  danger: 'bg-rose-50 text-rose-800 border-rose-200/80 dark:bg-rose-950/60 dark:text-rose-300 dark:border-rose-800/80',
  blue: 'bg-blue-50 text-blue-800 border-blue-200/80 dark:bg-blue-950/60 dark:text-blue-300 dark:border-blue-800/80',
  info: 'bg-blue-50 text-blue-800 border-blue-200/80 dark:bg-blue-950/60 dark:text-blue-300 dark:border-blue-800/80',
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center border font-sans whitespace-nowrap leading-none transition-colors ${style} ${sizeStyles[size]} ${className}`}
    >
