...
const variantStyles: Record<string, string> = {
  ...
  warning: 'bg-orange-600 hover:bg-orange-700 text-white shadow-xs border border-orange-600 active:scale-[0.98]',
  ...
  danger: 'bg-rose-600 hover:bg-rose-700 text-white border border-rose-600 active:scale-[0.98]',
};
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center font-sans transition-all duration-150 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 select-none ${style} ${sizeStyles[size]} ${className}`}
      {...props}
    >
      {isLoading ? (
