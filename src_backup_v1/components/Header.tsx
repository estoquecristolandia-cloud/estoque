...
import { Package, LayoutDashboard, ArrowDownLeft, ArrowUpRight, FileText, Utensils, Menu, X, User, Users } from 'lucide-react';
import { AppUserProfile, ROLE_LABELS } from '../firebase';

interface HeaderProps {
  activeTab: 'dashboard' | 'products' | 'entries' | 'exits' | 'reports';
  setActiveTab: (tab: 'dashboard' | 'products' | 'entries' | 'exits' | 'reports') => void;
  onOpenKitModal: () => void;
